...
namespace Sistema_Inventarios
{
    public partial class frmFacturas : Form
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Columna 1", new Font("Arial", 14, FontStyle.Regular), Brushes.Black, new Point(50, 500));
            e.Graphics.DrawString("Columna 2", new Font("Arial", 14, FontStyle.Regular), Brushes.Black, new Point(150, 500));
            e.Graphics.DrawString("Columna 2", new Font("Arial", 14, FontStyle.Regular), Brushes.Black, new Point(250, 500));
        }
